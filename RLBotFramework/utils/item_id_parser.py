...
'spark': 'Gizmo', 'torch': 'X-Devil', 'torment': 'Hotshot', 'vanquish': 'Merc', 'venom': 'Venom',
'import': 'Takumi', 'musclecar': 'Dominus', 'zippy': 'Zippy', 'scarab': 'Scarab', 'interceptor': 'Ripper',
'wastelandtruck': 'Grog', 'musclecar2': 'Dominus GT', 'torch2': 'X-Devil Mk2', 'neocar': 'Masamune',
'rhino2': 'Road Hog XL', 'takumi': 'Takumi RX-T', 'aftershock': 'Aftershock', 'neobike': 'Esper',
'marauder': 'Marauder', 'carcar': 'Breakout Type-S', 'number6': 'Proteus', 'cannonboy': 'Triton',
'o2': 'Octane ZSR', 'gilliam': 'Vulcan', 'bone': 'Bone Shaker', 'scallop': 'Twin Mill III', 'endo': 'Endo',
'charged': 'Ice Charger', 'flatbread': 'Mantis', 'pumpernickel': 'Centio V17', 'focaccia': 'Animus GP',
'challah': "'70 Dodge Charger R/T", 'melonpan': "'99 Nissan Skyline GT-R R34", 'levain': 'Werewolf',
'greycar': 'DeLorean Time Machine', 'interceptor': 'Interceptor_SF', 'darkcar': "'16 Batmobile",
'takumi_ii': 'Takumi RX-T', 'sourdough': 'Jäger 619 RS', 'multigrain': 'Imperator DT5',
'berry': 'The Dark Knight Rises Tumbler', 'eggplant': "'89 Batmobile", 'Universal Decal': 'Universal Decal'}
...
for line in data:
    ...
    if (ID=='0' or AssetPackageName == 'seasonlogos' or
    AssetPackageName == 'itemcontainer' or
    AssetPackageName == 'bots' or
    'key' in AssetPackageName or
    'pack' in AssetPackageName):
        continue
